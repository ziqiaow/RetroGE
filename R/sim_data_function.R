...
simFit <- function(ncontrol=500, ncase=500,
                   beta0=-5, betaG_normPRS=0.450,betaE_bin=0.143, betaE_norm=-0.019,betaGE_normPRS_bin=0, betaGE_normPRS_norm=-0.40,E_bin_freq=0.745,strata=TRUE,interact_strata_prs=FALSE,beta_strata=c(0.1,0.1,0.1),beta_strata_interact=c(0.4,0.4,0.4),sigma_strata=c(0.25,0.5,1),mu_strata=c(1,0.4,0.8,0.9)){
  ...
  if(strata==TRUE){
    ...
    prs <- rnorm(n=n_pop,mean=tmp_mu_sim,sd=sigma_sim)} else {
